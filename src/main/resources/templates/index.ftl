...
<div id="menu">
  <a id="btStartAudioVisualization" class="bt" style="display: inline-block;">Pause Audio</a>
  <input id="btLoadAudio" type="file" accept="audio/*"><label id="labelLoadAudio" for="btLoadAudio" class="bt" style="display: inline-block;">加载音频</label>
</div>

<p id="txtStatus">Song: LAKEY INSPIRED - Chill Day</p>
...
init();</script><canvas width="1536" height="722"></canvas>
